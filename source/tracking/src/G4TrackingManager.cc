...
fpSteppingManager = (G4SteppingManager *)malloc(sizeof(G4SteppingManager));
memset(fpSteppingManager, 0, sizeof(G4SteppingManager));
fpSteppingManager = new (fpSteppingManager)G4SteppingManager();
//  messenger = new G4TrackingMessenger(this);
messenger = (G4TrackingMessenger *)malloc(sizeof(G4TrackingMessenger));
memset(messenger, 0, sizeof(G4TrackingMessenger));
messenger = new (messenger)G4TrackingMessenger(this);
}
