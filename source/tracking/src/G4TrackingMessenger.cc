...
TrackingDirectory = (G4UIdirectory *)malloc(sizeof(G4UIdirectory));
memset(TrackingDirectory, 0, sizeof(G4UIdirectory));
TrackingDirectory = new (TrackingDirectory)G4UIdirectory("/tracking/");
...
AbortCmd = (G4UIcmdWithoutParameter *)malloc(sizeof(G4UIcmdWithoutParameter));
memset(AbortCmd, 0, sizeof(G4UIcmdWithoutParameter));
AbortCmd = new (AbortCmd)G4UIcmdWithoutParameter("/tracking/abort",this);

  AbortCmd->SetGuidance("Abort current G4Track processing.");


//  ResumeCmd = new G4UIcmdWithoutParameter("/tracking/resume",this);
ResumeCmd = (G4UIcmdWithoutParameter *)malloc(sizeof(G4UIcmdWithoutParameter));
memset(ResumeCmd, 0, sizeof(G4UIcmdWithoutParameter));
ResumeCmd = new (ResumeCmd)G4UIcmdWithoutParameter("/tracking/resume",this);
...
StoreTrajectoryCmd = (G4UIcmdWithAnInteger *)malloc(sizeof(G4UIcmdWithAnInteger));
memset(StoreTrajectoryCmd, 0, sizeof(G4UIcmdWithAnInteger));
StoreTrajectoryCmd = new (StoreTrajectoryCmd)G4UIcmdWithAnInteger("/tracking/storeTrajectory",this);
...
VerboseCmd = (G4UIcmdWithAnInteger *)malloc(sizeof(G4UIcmdWithAnInteger));
memset(VerboseCmd, 0, sizeof(G4UIcmdWithAnInteger));
VerboseCmd = new (VerboseCmd)G4UIcmdWithAnInteger("/tracking/verbose",this);
#ifdef G4VERBOSE
