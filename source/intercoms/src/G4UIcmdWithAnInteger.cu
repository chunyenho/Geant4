...
{
/* Modify 2015/11/19 */
  G4UIparameter * intParam;
//  intParam = new G4UIparameter('i');
intParam = (G4UIparameter *)malloc(sizeof(G4UIparameter));
memset(intParam, 0, sizeof(G4UIparameter));
intParam = new (intParam)G4UIparameter('i');
