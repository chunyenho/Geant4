...
trackManager = (G4TrackingManager *)malloc(sizeof(G4TrackingManager));
memset(trackManager, 0, sizeof(G4TrackingManager));
trackManager = new (trackManager)G4TrackingManager;
//  transformer = new G4PrimaryTransformer; 
transformer = (G4PrimaryTransformer *)malloc(sizeof(G4PrimaryTransformer));
memset(transformer, 0, sizeof(G4PrimaryTransformer));
transformer = new (transformer)G4PrimaryTransformer;
//  trackContainer = new G4StackManager;
trackContainer = (G4StackManager *)malloc(sizeof(G4StackManager));
memset(trackContainer, 0, sizeof(G4StackManager));
trackContainer = new (trackContainer)G4StackManager;
//  theMessenger = new G4EvManMessenger(this);
theMessenger = (G4EvManMessenger *)malloc(sizeof(G4EvManMessenger));
memset(theMessenger, 0, sizeof(G4EvManMessenger));
theMessenger = new (theMessenger)G4EvManMessenger(this);
