...
eventDirectory = (G4UIdirectory *)malloc(sizeof(G4UIdirectory));
memset(eventDirectory, 0, sizeof(G4UIdirectory));
eventDirectory = new (eventDirectory)G4UIdirectory("/event/");
...
abortCmd = new (abortCmd)G4UIcmdWithoutParameter("/event/abort",this);
...
verboseCmd = new (verboseCmd)G4UIcmdWithAnInteger("/event/verbose",this);
...
storeEvtCmd = (G4UIcmdWithoutParameter *)malloc(sizeof(G4UIcmdWithoutParameter));
memset(storeEvtCmd, 0, sizeof(G4UIcmdWithoutParameter));
storeEvtCmd = new (storeEvtCmd)G4UIcmdWithoutParameter("/event/keepCurrentEvent",this);
