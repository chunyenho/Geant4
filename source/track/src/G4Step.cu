...
fpPreStepPoint = (G4StepPoint *)malloc(sizeof(G4StepPoint));
memset(fpPreStepPoint, 0, sizeof(G4StepPoint));
fpPreStepPoint = new (fpPreStepPoint)G4StepPoint();

// fpPostStepPoint = new G4StepPoint();
fpPostStepPoint = (G4StepPoint *)malloc(sizeof(G4StepPoint));
memset(fpPostStepPoint, 0, sizeof(G4StepPoint));
fpPostStepPoint = new (fpPostStepPoint)G4StepPoint();
